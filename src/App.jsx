    ...
    <div className="max-w-md mx-auto min-h-screen bg-[#F8FAFF] font-sans text-slate-900 pb-28 relative overflow-x-hidden">
      <header className="px-6 py-5 flex items-center justify-between sticky top-0 bg-white/90 backdrop-blur-md z-40 border-b border-slate-100">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">
              Hora de Leer
            </h1>
          ...
          <div className="space-y-6">
            {!userData.level ? (
              <div className="bg-indigo-600 p-8 rounded-[2.5rem] text-white shadow-xl relative overflow-hidden">
                ...
                <p className="text-indigo-100 text-sm mt-2 mb-6 opacity-80">
                  Detecta el nivel ideal para tu hijo hoy.
                </p>
                <button
                  onClick={() => setView('quiz')}
                  className="w-full bg-white text-indigo-600 py-4 rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg"
                >
              ...
              <div className="bg-white p-6 rounded-[2.5rem] shadow-sm border border-slate-100 flex items-center justify-between group">
                ...
                <button
                  onClick={() => setView('quiz')}
                  className="p-3 bg-slate-50 rounded-2xl text-slate-300 hover:text-indigo-600 transition-colors"
                >
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[11px] font-bold text-slate-500">Progreso de hoy</span>
                ...
                <div className="grid grid-cols-3 gap-3 text-center">
                  <div className="bg-indigo-50 rounded-2xl p-3">
                    <p className="text-lg font-black text-indigo-700">{userData.totalMinutesRead}</p>
                    <p className="text-[9px] font-black text-slate-400 uppercase">Minutos</p>
                  </div>
                  ...
                  <div className="bg-amber-50 rounded-2xl p-3">
                    ...
                    <p className="text-[9px] font-black text-slate-400 uppercase">Tareas</p>
                  </div>

                  <div className="bg-emerald-50 rounded-2xl p-3">
                    <p className="text-lg font-black text-emerald-600">{userData.streak}</p>
                    <p className="text-[9px] font-black text-slate-400 uppercase">Racha</p>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <span
                        className={cn(
                          'text-xs font-bold',
                          item.completed
                            ? 'text-emerald-700 opacity-50 line-through'
                            : 'text-slate-600'
                        )}
                      >
                        {item.text}
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  ...
                  className="bg-indigo-600 p-4 rounded-3xl text-white shadow-lg text-center transition-all active:scale-95"
                >
                ...
                <button
                  ...
                  className="bg-indigo-700 p-4 rounded-3xl text-white shadow-lg text-center transition-all active:scale-95"
                >
                  <Timer className="w-5 h-5 mb-1.5 opacity-40 mx-auto" />
                ...
                <button
                  ...
                  className="bg-indigo-800 p-4 rounded-3xl text-white shadow-lg text-center transition-all active:scale-95"
                >
                  <Timer className="w-5 h-5 mb-1.5 opacity-40 mx-auto" />
            ...
            <button
              onClick={() => setView('sos')}
              className="w-full bg-rose-50 border border-rose-100 p-6 rounded-[2rem] flex items-center justify-between group transition-all active:scale-95"
            >
          ...
          <div className="space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-xs font-bold text-slate-400">
                Canjea tus estrellas por premios para tu pequeño
              </p>
            </div>
              ...
              {shopItems.map((item) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      owned
                        ...
                        : canAfford
                        ? 'bg-white border-slate-100 hover:border-indigo-500 shadow-sm active:scale-95'
                  ...
                  >
                    ...
                    <p className="text-[10px] font-black uppercase text-slate-800 mb-1 leading-none">
                      {item.title}
                    </p>
                    <div
                      className={cn(
                        'text-[10px] font-black py-1 px-3 rounded-full mt-2',
                        owned ? 'bg-slate-200 text-slate-500' : 'bg-amber-100 text-amber-600'
                      )}
                    >
                ...
                {shopItems.filter((i) => userData.unlockedItems.includes(i.id)).length === 0 ? (
                  <div className="col-span-3 py-10 text-center space-y-3">
                    ...
                    <button
                      ...
                      className="text-[10px] font-black text-indigo-500 bg-indigo-50 px-4 py-2 rounded-full uppercase"
                    >
                      Ir a comprar
                    </button>
                  </div>
                  ...
                  shopItems.map((item) => {
                    ...
                    return (
                      <div
                        key={item.id}
                        className="aspect-square rounded-[2rem] bg-indigo-50 border border-indigo-100 flex flex-col items-center justify-center p-2 text-center"
                      >
                        <span className="text-3xl mb-1">{item.icon}</span>
                        <span className="text-[8px] font-black uppercase text-indigo-700 leading-none">
                          {item.title}
                        </span>
                      </div>
                    );
          ...
          <div className="text-center space-y-12 py-10">
            <div className="relative inline-flex items-center justify-center">
              ...
              <div className="absolute flex flex-col">
                ...
                <span className="text-[10px] font-black text-indigo-500 uppercase tracking-widest mt-2">
                  Lectura con Amor
                </span>
              </div>
            </div>
            ...
            <div className="bg-indigo-600 p-8 rounded-[2.5rem] text-white shadow-xl mx-4">
              <p className="text-sm font-bold italic leading-relaxed">
                {timer > 0
                  ? 'Cada palabra es un escalón más en su confianza. Sonríe.'
                  : '¡SESIÓN TERMINADA! Recoge tus 15 estrellas.'}
              </p>
            </div>
            ...
            <div className="px-6 space-y-4">
              {timer === 0 ? (
                <button
                  ...
                  className="w-full bg-emerald-500 text-white py-5 rounded-2xl font-black text-lg shadow-xl uppercase"
                >
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {[
                {
                  t: 'No quiere empezar',
                  d: "No pelees. Usa el 'LectoJuego Sinfonía'. Si hoy no es el día, descansen. El vínculo es más importante que la letra.",
                },
                {
                  t: 'Se frustra y llora',
                  d: "Detente. Un abrazo de 10 segundos libera calma. Dile: 'Tú eres capaz, solo estamos practicando'.",
                },
                {
                  t: 'Se distrae mucho',
                  d: 'Reduce el tiempo a solo 2 minutos. Menos presión, más éxito.',
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm space-y-2"
                >
                  <p className="font-black text-rose-600 text-[10px] uppercase tracking-widest">
                    {item.t}
                  </p>
      ...
      {celebration && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
          ...
          <div className="text-center relative z-10 space-y-8">
            <div className="w-40 h-40 bg-white rounded-[3rem] flex items-center justify-center mx-auto shadow-2xl">
            ...
            <button
              ...
              className="bg-white text-indigo-600 px-12 py-5 rounded-3xl font-black uppercase tracking-widest shadow-2xl active:scale-95 transition-all"
            >
              Ver mi Colección
            </button>
          </div>
      ...
      <nav className="fixed bottom-0 left-0 w-full bg-white/90 backdrop-blur-lg border-t border-slate-100 px-6 py-4 flex justify-around items-center z-50 rounded-t-[2.5rem] shadow-[0_-10px_40px_rgba(0,0,0,0.03)]">
        <button
          ...
          className={cn(
            ...
            view === 'home' || view === 'quiz' ? 'text-indigo-600 scale-110' : 'text-slate-300'
          )}
        >
        ...
        <button
          ...
          className={cn(
            'flex flex-col items-center gap-1.5 transition-all',
            view === 'shop' ? 'text-amber-500 scale-110' : 'text-slate-300'
          )}
        >
        ...
        <button
          ...
          className={cn(
            'flex flex-col items-center gap-1.5 transition-all',
            view === 'stats' ? 'text-indigo-600 scale-110' : 'text-slate-300'
          )}
        >
        ...
        <button
          ...
          className={cn(
            'flex flex-col items-center gap-1.5 transition-all',
            view === 'sos' ? 'text-rose-600 scale-110' : 'text-slate-300'
          )}
        >
